  ...
  return (
    <div className="flex gap-5 border p-5 shadow-md rounded">
      ...
      <div>
        ...
        <Link
          href={`/book/${book._id}`}
          className="py-2 px-2 rounded border border-primary-500 mt-4 inline-block text-primary-500 font-medium text-sm hover:border-primary-100 hover:bg-primary-100 transition"
        >
          Read more
        </Link>
      </div>
